...
class UserInfoAdmin(object):
  list_display = ['_id', 'nick_name', 'gender', 'labels', 'province', 'city', 'brief_introduction', 'birthday', 'constellation',
                    'tweets_num', 'fans_num','follows_num', 'sex_orientation', 'sentiment', 'vip_level', 'authentication', 'person_url', 'crawl_time']
  search_fields = ['_id', 'nick_name', 'gender', 'labels', 'province', 'city', 'brief_introduction', 'birthday', 'constellation',
                    'tweets_num', 'fans_num','follows_num', 'sex_orientation', 'sentiment', 'vip_level', 'authentication', 'person_url', 'crawl_time']
  list_filter = ['_id', 'nick_name', 'gender', 'labels', 'province', 'city', 'brief_introduction', 'birthday', 'constellation',
                    'tweets_num', 'fans_num','follows_num', 'sex_orientation', 'sentiment', 'vip_level', 'authentication', 'person_url', 'crawl_time']
